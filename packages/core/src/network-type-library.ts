...
export const NETWORK_TYPE_LIBRARY: NetworkType[] = [
  ...
  { id: 'conduit', name: 'Conduit', discipline: 'electrical', units: '', defaultCapacity: 0, color: '#757575', lineWidthPt: 2, linePattern: 'solid' },
  { id: 'cable-tray', name: 'Cable Tray', discipline: 'electrical', units: '', defaultCapacity: 0, color: '#9e9e9e', lineWidthPt: 2, linePattern: 'dashed' },
  { id: 'branch-circuit', name: 'Branch Circuit', discipline: 'electrical', units: 'A', defaultCapacity: 20, color: '#fdd835', lineWidthPt: 2, linePattern: 'solid' },
  { id: 'feeder', name: 'Feeder', discipline: 'electrical', units: 'A', defaultCapacity: 100, color: '#fbc02d', lineWidthPt: 3, linePattern: 'solid' },
