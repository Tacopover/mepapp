...
- 5b-2 Fields and the saved schematic (core, project schema, dialogs). Status: core done (`7251d9c`); built (both parts: saved schematics, fields form, overrides, template fields editor), not yet browser-verified.
